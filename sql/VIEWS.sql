...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE VIEW "STUDENT_VIEW" ("GRADE", "STUDENT_ID", "PESEL", "ADMISSION_DATE", "YEAR", "SEMESTER", "FIRST_NAME", "LAST_NAME", "EMAIL", "NAME", "NAME2") AS SELECT
	"RECORD".GRADE,
	STUDENT.STUDENT_ID,
	STUDENT.PESEL,
