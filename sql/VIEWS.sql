...
CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "BD"."GROUP_VIEW" ("PROFESSOR_ID", "DEGREE", "FIRST_NAME", "LAST_NAME","GROUP_ID", "SUBJECT_ID", "SUBJECT_NAME", "PARITY", "TIME", "FORM", "DAY", "STUDENT_LIMIT") AS
SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE VIEW "PROFESSOR_VIEW" ("PROFESSOR_ID", "DEGREE", "FIRST_NAME", "LAST_NAME", "EMAIL", "FACULTY") AS SELECT
	PROFESSOR.PROFESSOR_ID,
	PROFESSOR.DEGREE,
	PERSONAL_DATA.FIRST_NAME,
	PERSONAL_DATA.LAST_NAME,
...
FROM
    STUDENT LEFT JOIN
    "RECORD" ON STUDENT.STUDENT_ID = "RECORD".STUDENT_ID JOIN
    PERSONAL_DATA ON STUDENT.STUDENT_ID = PERSONAL_DATA.USER_ID JOIN
    SPECIALIZATION ON STUDENT.SPECIALIZATION_ID = SPECIALIZATION.SPECIALIZATION_ID JOIN
    FACULTY ON PERSONAL_DATA.FACULTY_ID = FACULTY.FACULTY_ID AND SPECIALIZATION.FACULTY_ID = FACULTY.FACULTY_ID
GROUP BY
    "RECORD".GRADE,
    STUDENT.STUDENT_ID,
    STUDENT.PESEL,
